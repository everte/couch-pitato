defmodule Ui.Firmware.Light do
  ...
  def changeset(light, attrs) do
    light
    |> cast(attrs, [:name, :ui_name, :ui_group_name, :ui_group_order, :ui_order, :default_w, :default_r, :default_g, :default_b, :dmx_channel_w, :dmx_channel_r, :dmx_channel_g, :dmx_channel_b, :rgb])
    |> validate_required([:name, :ui_name, :ui_group_name, :ui_group_order, :ui_order, :default_w, :default_r, :default_g, :default_b, :dmx_channel_w, :dmx_channel_r, :dmx_channel_g, :dmx_channel_b, :rgb])
  end
end
